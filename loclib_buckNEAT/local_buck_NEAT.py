...
# directorio "top"
# import Intercambio.local_learn_f_neat2.exp1.exp1_model as sin

import local_buck_neat37.common.visualize as vis
import local_buck_neat37.funciones.dcdc_converter as func
import local_buck_neat37.common.configuracion as conf
...
def run_experiment(path_results, graphs_path, checkpoints_path, config_file, dcdc_config, checkpoint=None,
    ...
    try:
        ...
        node_names = {-1: 'Vin', -2: 'Iout', -3: 'Vout', 0: 'output_d'}
